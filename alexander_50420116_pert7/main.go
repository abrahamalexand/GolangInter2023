...
func dbConn() (db *sql.DB) {
	dbDriver := "mysql"
	dbName := "alexander_50420116_pert7" // Diganti menjadi nama database kalian masing-masing
	dbUser := "root"
	dbPass := ""
...
func main() {
	...
	srv := &http.Server{
		Handler:      r,
		Addr:         "127.0.0.1:8016", // 2 angka belakang port diganti menjadi 2 angka dibelakang npm masing-masing
		WriteTimeout: 15 * time.Second,
		ReadTimeout:  15 * time.Second,
	}

	log.Print("Server berjalan di http://127.0.0.1:8016") // 2 angka belakang port diganti menjadi 2 angka dibelakang npm masing-masing
	srv.ListenAndServe()
}
